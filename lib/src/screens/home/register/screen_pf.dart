...
import 'package:estruturabasica/src/controllers/people_controller.dart';
    ...
    child: Container(
      ...
      child: Form(
        child: Column(
          children: [
            Container(
              child: label("Dados da Pessoa Física",
                  fontSize: 20, align: MainAxisAlignment.center),
            ),
            Divider(),
            labelFieldRequired("CPF"),
            SizedBox(height: 5),
            Observer(builder: (_) {
